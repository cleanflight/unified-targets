...
1. For all pull requests that add or update a Unified Target configuration, please read and follow [these instructions](https://github.com/cleanflight/cleanflight/blob/master/docs/TargetMaintenance/CreatingAUnifiedTarget.md).
...
4. Please follow the coding style guidelines: https://github.com/cleanflight/cleanflight/blob/master/docs/development/CodingStyle.md
